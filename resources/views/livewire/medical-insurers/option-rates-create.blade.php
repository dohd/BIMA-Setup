                    ...
                    <tbody>
                        @foreach ($inpatients as $i => $item)
                            <tr>
                                ...
                                <td><input type="text" wire:model.defer="inpatients.{{$i}}.limit_label" class="form-control col-12" value="Spouse"></td>
                                <td>
                    ...
                    <tbody>
                        @foreach ($outpatients as $i => $item)
                            <tr>
                                ...
                                <td><input type="text" wire:model.defer="outpatients.{{$i}}.limit_label" class="form-control col-12" value="Spouse"></td>
                                <td>
                                    <div class="row g-1" style="width:12em;">
                    ...
                    <tbody>
                        @foreach ($maternities as $i => $item)
                            <tr>
                                ...
                                <td><input type="text" wire:model.defer="maternities.{{$i}}.limit_label" class="form-control col-12" value="Spouse"></td>
                                <td>
                                    <div class="row g-1" style="width:12em;">
                    ...
                    <tbody>
                        @foreach ($dentals as $i => $item)
                            <tr>
                                ...
                                <td><input type="text" wire:model.defer="dentals.{{$i}}.limit_label" class="form-control col-12" value="Spouse"></td>
                                <td>
                                    <div class="row g-1" style="width:12em;">
                    ...
                    <tbody>
                        @foreach ($opticals as $i => $item)
                            <tr>
                                ...
                                <td><input type="text" wire:model.defer="opticals.{{$i}}.limit_label" class="form-control col-12" value="Spouse"></td>
                                <td>
                                    <div class="row g-1" style="width:12em;">
